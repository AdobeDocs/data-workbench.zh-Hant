...
user-guide-description: 瞭解 Data Workbench 的多通道功能。包含 Data Workbench 用戶端、安裝、資料集設定指南，以及更多功能。
...
+ 用戶端 {#client}
   ...
   + 視覺效果 {#visualizations}
      ...
      + 進行選取 {#make-selections}
         ...
         + [縮放以檢視視覺效果](home/c-get-started/c-vis/c-sel-vis/dwb-zoom-regression-view.md)
   ...
   + 分析視覺效果 {#analysis-visualizations}
      ...
      + 表格 {#tables}
         ...
         + [排序表格中的資料](home/c-get-started/c-analysis-vis/c-tables/c-sort-data.md)
   ...
   + 管理介面 {#admin-ui}
      ...
      + 資料集管理員 {#dataset-mgrs}
         ...
         + 相依圖 {#dep-maps}
            ...
            + [編輯設定檔元件](home/c-get-started/c-admin-intrf/c-dataset-mgrs/c-dep-maps/t-edit-prof-comp.md)
...
+ 頁面標記 {#page-tagging}
   ...
   + 取得基線測量資料 {#acquire-base-measures}
      ...
      + [取得內嵌物件要求 (頁面標記)](home/c-undst-pg-tag/c-acq-bsln-msmts/c-embed-obj-req.md)
...
+ Geography {#geography}
   ...
   + 影像層 {#imagery-layers}
      ...
      + 向量層 {#vector-layers}
         ...
         + [定義參考向量檔案的向量層](home/c-geo-oview/c-wk-img-lyrs/c-wk-vctr-lyrs/c-def-vctr-files.md)
         + [參考 Tab 字元分隔值檔案的向量層](home/c-geo-oview/c-wk-img-lyrs/c-wk-vctr-lyrs/c-tab-sep-val-files.md)
...
+ Sensor {#sensor}
   ...
   + 安裝 {#install}
      ...
      + [Windows Server 2000 或更新版本上的 Apache Server 1.3、2、2.2 或 2.4](home/c-snsr-ovrvw/c-inst-snsr/c-install-apache-1-3-2-2.md)
   ...
   + 組態檔範例 {#sample-configs}
      + [組態檔範例](home/c-snsr-ovrvw/sensor-sample-configs/sensor-sample-configs.md)
      + [Txlogd.conf 檔案範例](home/c-snsr-ovrvw/sensor-sample-configs/txlogd-conf-samples.md)
   + [Sensor 傳送器命令列選項](home/c-snsr-ovrvw/sensor-transmitter-options.md)
   + [Sensor UNIX 檔案權限](home/c-snsr-ovrvw/sensor-unix-permissions.md)
+ 安裝監控設定檔 {#monitor}
   + [安裝監控設定檔](home/monitoring-installation/monitoring-installation.md)
   + 工作區 {#workspace}
      + [用於監控 Data Workbench 伺服器的工作區](home/monitoring-installation/monitoring-profiles/monitoring-profiles.md)
      + [Data Workbench 歷史工作區](home/monitoring-installation/monitoring-profiles/monitoring-historical-using.md)
      + [Data Workbench 設定檔狀態工作區](home/monitoring-installation/monitoring-profiles/monitoring-profile-using.md)
      + [Data Workbench 伺服器狀態工作區](home/monitoring-installation/monitoring-profiles/monitoring-server-using.md)
   + Data Workbench 設定檔維度與量度 {#monitoring-appendix}
      + [Data Workbench 設定檔維度與量度](home/monitoring-installation/monitoring-appendix/monitoring-appendix.md)
      + [Data Workbench 歷史設定檔中的維度](home/monitoring-installation/monitoring-appendix/monitoring-historical.md)
      + [Data Workbench 設定檔狀態設定檔中的維度](home/monitoring-installation/monitoring-appendix/monitoring-profile-status.md)
      + [Data Workbench 伺服器狀態設定檔中的維度](home/monitoring-installation/monitoring-appendix/monitoring-servers-profile.md)
      + [Data Workbench 歷史監控設定檔中的量度](home/monitoring-installation/monitoring-appendix/monitoring-hist-metrics.md)
+ 控制面板 {#dashboard}
   ...
   + [控制面板使用者介面](home/c-adobe-data-workbench-dashboard/t-getting-started/c-dashboard-user-interface.md)
   + 視覺效果 {#visualizations}
      + [視覺效果](home/c-adobe-data-workbench-dashboard/c-visualizations/c-visualizations.md)
      + 視覺效果類型 {#visualization-types}
         + [視覺效果類型](home/c-adobe-data-workbench-dashboard/c-visualizations/c-visualization-types/c-visualization-types.md)
         + [直條圖](home/c-adobe-data-workbench-dashboard/c-visualizations/c-visualization-types/c-column-charts.md)
         + [橫條圖](home/c-adobe-data-workbench-dashboard/c-visualizations/c-visualization-types/c-bar-charts.md)
         ...
         + [RTF 文字](home/c-adobe-data-workbench-dashboard/c-visualizations/c-visualization-types/c-rich-text.md)
      + [建立視覺效果](home/c-adobe-data-workbench-dashboard/c-visualizations/t-creating-visualizations.md)
      + [設定視覺效果](home/c-adobe-data-workbench-dashboard/c-visualizations/c-configuring-visualizations.md)
      + 操控視覺效果 {#manipulating-visualizations}
         + [操控視覺效果](home/c-adobe-data-workbench-dashboard/c-visualizations/c-manipulating-visualizations/c-manipulating-visualizations.md)
         ...
         + [收合和展開視覺效果](home/c-adobe-data-workbench-dashboard/c-visualizations/c-manipulating-visualizations/c-collapsing-and-expanding-visualizations.md)
         + [匯出視覺效果](home/c-adobe-data-workbench-dashboard/c-visualizations/c-manipulating-visualizations/c-exporting-visualizations.md)
         + [設定視覺效果](home/c-adobe-data-workbench-dashboard/c-visualizations/c-manipulating-visualizations/c-configure-visualizations.md)
         + [移除視覺效果](home/c-adobe-data-workbench-dashboard/c-visualizations/c-manipulating-visualizations/c-remove-visualizations.md)
         + [調整視覺效果大小](home/c-adobe-data-workbench-dashboard/c-visualizations/c-manipulating-visualizations/c-sizing-visualizations.md)
   ...
   + 控制面板 {#dashboards}
      ...
      + 檢視控制面板 {#viewing-dashboards}
         ...
         + 控制面板瀏覽器 {#dashboard-browser}
            + [控制面板瀏覽器](home/c-adobe-data-workbench-dashboard/c-dashboards/c-opening-and-viewing-dashboards/c-dashboard-browser/c-dashboard-browser.md)
      ...
      + [查詢完成度參數](home/c-adobe-data-workbench-dashboard/c-dashboards/c-query-to-parameter.md)
      ...
      + [其他控制面板功能](home/c-adobe-data-workbench-dashboard/c-dashboards/c-other-dashboard-functions.md)
      + [控制面板共用與存取控制](home/c-adobe-data-workbench-dashboard/c-dashboards/c-dashboard-sharing-and-access-controls.md)
   + 選取 {#select}
      + [在控制面板中進行選取](home/c-adobe-data-workbench-dashboard/c-making-selections-within-the-dashboard/c-making-selections-within-the-dashboard.md)
      + [鎖定的選取項目](home/c-adobe-data-workbench-dashboard/c-making-selections-within-the-dashboard/c-locked-selections.md)
      + [套用選取項目](home/c-adobe-data-workbench-dashboard/c-making-selections-within-the-dashboard/t-applying-selections.md)
      + [移除選取項目](home/c-adobe-data-workbench-dashboard/c-making-selections-within-the-dashboard/c-removing-selections.md)
      + [決定要選取的項目](home/c-adobe-data-workbench-dashboard/c-making-selections-within-the-dashboard/c-determining-whats-selected.md)
      + [跨設定檔選取項目](home/c-adobe-data-workbench-dashboard/c-making-selections-within-the-dashboard/c-cross-profile-selections.md)
...
+ 控制面板管理員 {#admin}
   + [最低系統需求](home/c-preparing-for-dashboard-installation/c-minimum-system-requirements.md)
   + [下載必要和選用元件](home/c-preparing-for-dashboard-installation/c-download-required-and-optional-components.md)
   + [受支援的瀏覽器](home/c-preparing-for-dashboard-installation/c-supported-browsers.md)
   + 安裝必備條件 {#installation-prerequisites}
      + [安裝必備條件](home/c-preparing-for-dashboard-installation/c-installation-prerequisites/c-installation-prerequisites.md)
      + [啟用 IIS](home/c-preparing-for-dashboard-installation/c-installation-prerequisites/t-enabling-iis.md)
      + [安裝必要元件](home/c-preparing-for-dashboard-installation/c-installation-prerequisites/t-installing-required-components.md)
   + 伺服器通訊 {#servers-communication}
      + [Data Workbench 伺服器通訊控制面板](home/c-preparing-for-dashboard-installation/c-dashboard-to-data-workbench-servers-communication/c-dashboard-to-data-workbench-servers-communication.md)
      + [驗證查詢 API 啟用](home/c-preparing-for-dashboard-installation/c-dashboard-to-data-workbench-servers-communication/t-verifying-qurey-api-enablement.md)
      + [設定存取控制](home/c-preparing-for-dashboard-installation/c-dashboard-to-data-workbench-servers-communication/t-configuring-access-control.md)
   + 控制面板部署 {#dashboard-deployment}
      + [控制面板部署](home/c-preparing-for-dashboard-installation/c-dashboard-deployment/c-dashboard-deployment.md)
      + [部署控制面板](home/c-preparing-for-dashboard-installation/c-dashboard-deployment/t-deploying-the-dashboard.md)
      + [設定 SQL Server](home/c-preparing-for-dashboard-installation/c-dashboard-deployment/t-configuring-the-sql-server.md)
   ...
   + 設定檔連線 {#profile-connections}
      + [管理設定檔連線](home/c-preparing-for-dashboard-installation/c-managing-profile-connections/c-managing-profile-connections.md)
      + [新增設定檔連線](home/c-preparing-for-dashboard-installation/c-managing-profile-connections/t-adding-a-profile-connection.md)
      + [編輯設定檔連線](home/c-preparing-for-dashboard-installation/c-managing-profile-connections/t-editing-a-profile.md)
      + [刪除設定檔連線](home/c-preparing-for-dashboard-installation/c-managing-profile-connections/t-removing-a-profile-connection.md)
   + 結構 {#schema}
      + [管理結構](home/c-preparing-for-dashboard-installation/c-managing-the-schema/c-managing-the-schema.md)
      + [初始化和更新設定檔的結構定義](home/c-preparing-for-dashboard-installation/c-managing-the-schema/t-initializing-and-updating-a-profiles-schema-definition.md)
   + 資料夾 {#folders}
      + [管理資料夾](home/c-preparing-for-dashboard-installation/c-managing-folders/c-managing-folders.md)
      + [新增資料夾](home/c-preparing-for-dashboard-installation/c-managing-folders/t-adding-folders.md)
      + [重新命名資料夾](home/c-preparing-for-dashboard-installation/c-managing-folders/t-renaming-folders.md)
   ...
   + 使用者帳戶 {#user-accounts}
      ...
      + [重設使用者密碼](home/c-preparing-for-dashboard-installation/t-managing-user-accounts/t-resetting-a-users-password.md)
   ...
   + [系統記錄](home/c-preparing-for-dashboard-installation/c-system-logs.md)
+ 實施 Data Workbench {#implement}
   + [實施 Adobe Data Workbench](home/dwb-implement-overview/dwb-implement-overview.md)
   + [Data Workbench 探索與需求](home/dwb-implement-overview/dwb-implement-discovery.md)
   + [Data Workbench 安裝與佈建](home/dwb-implement-overview/dwb-implement-provision/dwb-implement-provision.md)
   + [DWB Managed Services 的基本入門指示](home/dwb-implement-overview/dwb-implement-provision/dwb-implement-onboarding.md)
   + [Data Workbench 架構](home/dwb-implement-overview/dwb-implement-architecture/dwb-implement-architecture.md)
   + [結構設計可數架構](home/dwb-implement-overview/dwb-implement-architecture/dwb-implement-arch-countable.md)
   + [Data Workbench 管理](home/dwb-implement-overview/dwb-implement-admin.md)
   + 組態設定與實施 {#implement-configure}
      + [Data Workbench 的組態設定與實施](home/dwb-implement-overview/dwb-implement-configure/dwb-implement-configure.md)
      + [設定事件時間](home/dwb-implement-overview/dwb-implement-configure/dwb-implement-event-time.md)
      + [維度設定](home/dwb-implement-overview/dwb-implement-configure/dwb-implement-dim-setup.md)
      + [量度設定](home/dwb-implement-overview/dwb-implement-configure/dwb-implement-metric-setup.md)
      + [驗證內部和外部 FTP 伺服器](home/dwb-implement-overview/dwb-implement-configure/dwb-implement-validation-ftp.md)
      + [驗證歷史資料摘要](home/dwb-implement-overview/dwb-implement-configure/dwb-implement-datafeeds-historical.md)
      + [執行每週重新處理的指令碼](home/dwb-implement-overview/dwb-implement-configure/dwb-implement-reprocess-scripting.md)
      + [SAINT 清除程式的指令碼](home/dwb-implement-overview/dwb-implement-configure/dwb-implement-saint-scripting.md)
      + [檔案傳輸控管](home/dwb-implement-overview/dwb-implement-configure/dwb-implement-file-transfer.md)
      + [查詢 API 設定](home/dwb-implement-overview/dwb-implement-configure/dwb-implement-query-api.md)
      + [資料處理 - 建立主索引鍵](home/dwb-implement-overview/dwb-implement-configure/dwb-implement-primary-key.md)
   + 功能實施 {#feature-implemenatation}
      + [Data Workbench 功能實施](home/dwb-implement-overview/dwb-implement-deliver/dwb-implement-deliver.md)
      + [新結構的組態變更](home/dwb-implement-overview/dwb-implement-deliver/dwb-implement-config-new-schema.md)
      + [衍生維度設定](home/dwb-implement-overview/dwb-implement-deliver/dwb-implement-derived-dims.md)
+ [查詢 API](https://www.adobe.io/)
+ [Data Workbench 與 Adobe Target 整合](home/dwb-adobe-target.md)
