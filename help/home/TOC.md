...
+ 控制面板管理員 {#admin}
   ...
   + 伺服器通訊 {#servers-communication}
      ...
      + [設定儀表板存取控制](c-preparing-for-dashboard-installation/c-dashboard-to-data-workbench-servers-communication/t-configuring-access-control.md)
