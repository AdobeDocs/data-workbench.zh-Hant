...
| 詞語 | 定義 |
|---|---|
| 常值 | 常值是我們在規則運算式中用來尋找特定字元順序的字元。 例如，若要在 [!DNL shop/products.html]，字串產品是常值，或字串中我們實際尋找的。 |
...
<table id="table_6A14333D6C264A48ADF1EBBAF687CADD">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colname="col2"> <p>匹配正在處理的字元或範圍n次。 以下模式與美國電話號碼相符： <code>[0-9]{3}-[0-9]{3}-[0-9]{4}</code>. </p> <p> 雖然不是最佳模式，但會判斷目標字串是否為正確格式。 </p> </td>
  </tr>
  <tr>
...
## 模式擷取 {#section-4389779653b64f6cb7c47615b25c1a79}
...
<table id="table_BC8D471B966844049FFFCDEC0F183941">
 <thead>
  <tr>
   <th colname="col1" class="entry"> 圖樣 </th>
