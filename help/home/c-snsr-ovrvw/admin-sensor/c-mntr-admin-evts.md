...
您可以使用Windows事件查看器或Unix Syslog檔案來監視這些事件，並使用 [!DNL *.sensor-log] 預設位於 [!DNL Logs] 資料夾 [!DNL Sensor] 安裝目錄。 這些檔案表示資料收集期間發生錯誤，尤其是 [!DNL Sensor] 無法連接到目標 [!DNL data workbench server] 和開始排隊資料。
...
## 在Unix上監控事件 {#section-5de3947891fb47ac88b7c855e545d54a}
...
## 了解訊息格式 {#section-a0899add30fd4b2da58a23b9e3324693}
...
| 事件訊息 | 建議的動作 |
|---|---|
| 感測器錯誤3015:ns/server/[伺服器]/module/[模組] AOLServer配置檔案中缺少節。 | 這是配置錯誤。 正確無誤。 |
| 感測器錯誤3019:vys-log之前未呼叫vys-cookie。 請聯絡支援。 請連絡AdobeClientCare。 | 請聯絡支援。 請連絡AdobeClientCare。 |
| 感測器錯誤3020:VisualSciencesConfig缺少為 [節] AOLServer設定檔案中的「 」部分。 | 這是配置錯誤。 正確無誤。 |
| 感測器錯誤3021:VisualSciencesConfig缺少 [節] AOLServer設定檔案中的「 」部分。 | 這是配置錯誤。 正確無誤。 |
